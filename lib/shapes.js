(function () {
  ...
  var shapes = function () {
    const _self = this;
    $(`${this.containerSelector} .main-panel`).append(`<div class="toolpanel" id="shapes-panel"><p class="title">Shapes</p></div>`);

    ShapeList.forEach(svg => {
      $(`${this.containerSelector} .toolpanel#shapes-panel`).append(`<div class="button">${svg}</div>`)
    })

    $(`${this.containerSelector} .toolpanel#shapes-panel .button`).click(function () {
      let svg = $(this).html();
